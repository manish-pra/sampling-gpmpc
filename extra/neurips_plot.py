...
cost_random_init, solver_status_random_init, state_traj_random_init = load_data("data_random_init.pkl")
...
close_loop_regret_no_learning = np.linalg.norm(state_traj_opt - state_traj_no_learning, axis=1)
close_loop_regret_random_init = np.linalg.norm(state_traj_opt - state_traj_random_init, axis=1)
...
cum_regret_over_time_no_learning = np.cumsum(close_loop_regret_no_learning)/np.arange(1, len(close_loop_regret_no_learning)+1)
cum_regret_over_time_random_init = np.cumsum(close_loop_regret_random_init)/np.arange(1, len(close_loop_regret_random_init)+1)
...
plt.plot(cum_regret_over_time_no_learning, label="cummulative regret_no_learning")
plt.plot(cum_regret_over_time_random_init, label="cummulative regret_random_init")
plt.ylim(-0.1, 2.0)
plt.legend()
...
cost_full_expl, solver_status_full_expl, _ = load_data("data_full_expl.pkl")
cost_full_expl_true, solver_status_full_expl_true, _ = load_data("data_full_expl_true.pkl")

plt.plot(cost_random_init, label="cost_random_init")
