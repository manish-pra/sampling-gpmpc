...
model1_F_x_3 = torch.Tensor([[-2], [-0.45], [3]]) + 0.5
model1_F_y_3 = torch.Tensor([[0.6], [1], [1.2]]) - 0.1
...
Fx_X = torch.vstack([Fx_X_init, model1_F_x, model1_F_x_2])
Fx_Y = torch.vstack([Fx_Y_init, model1_F_y, model1_F_y_2])
# Fx_X = torch.vstack([Fx_X_init, model1_F_x])
# Fx_Y = torch.vstack([Fx_Y_init, model1_F_y])
...
plt.plot(model1_F_x_2, model1_F_y_2, '+', color='green',  ms=16, mew=3)
plt.plot(model1_F_x_3, model1_F_y_3, '*', color='green',  ms=16, mew=3)
...
plt.savefig(str(fname.joinpath('gp_orig_12.png')),
